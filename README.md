...
3. **Featured Projects** — FogBot (Autonomous Pilot Rover & IoT Command Center — Smart India Hackathon 2026, Team Track Decoders: Arka Datta [Lead Architect], Nihal Singh [Team Leader], Divyanshu [Hardware Designer], Deepak Jaish [Hardware Designer], Yuvraj [ML Architect], Pooja Thakur [Sponsor]), AI chatbot, automated toll gate, 4-DOF robotic arm, custom car brand site
